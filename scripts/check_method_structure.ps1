...
$required = @(
    ...
    "ai_method/12_METHOD_SELF_REVIEW.md",
    ...
    "skills/claim-register/SKILL.md",
    "skills/acquis-audit/SKILL.md",
    "skills/ask-board/SKILL.md",
    "skills/internal-focus-group/SKILL.md",
    "skills/method-review/SKILL.md",
    ...
    "evals/checklists/PERSPECTIVE_REVIEW_CHECKLIST.md",
    "evals/checklists/METHOD_COHERENCE_CHECKLIST.md",
