...
Le prochain travail recommandé est de créer les premières fiches `source_need` à partir des sources live fixes réellement garanties : `SOURCE_NEED_LIVE_JAW_HARPS_FORMANT_MICROPULSE` et/ou `SOURCE_NEED_LIVE_DIDGERIDOO_PRESSURE_FORMANTS`, avant les samples.
