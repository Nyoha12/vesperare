...
Le prochain travail recommandé est de créer `SOURCE_NEED_LIVE_DIDGERIDOO_PRESSURE_FORMANTS`, puis d’analyser les source_needs minimaux pour sub / pression, gong absent, tambour absent, voix éventuelle et field recordings éventuels.
