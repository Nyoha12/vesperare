...
Le prochain travail recommandé est d’analyser `SOURCE_NEED_OPTIONAL_GONG_ABSENCE_STRATEGY`, puis `SOURCE_NEED_OPTIONAL_FRAME_DRUM_ABSENCE_STRATEGY`, avant les éventuels besoins minimaux de voix et field recordings.
