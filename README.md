...
Le prochain travail recommandé est de réaliser un audit léger `Timbre / Material ↔ Object Registry / Pitch / Conflict`, puis de détailler les `Sound Engines / Instruments` sans choisir trop tôt les outils.
