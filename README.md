...
Le prochain travail recommandé est d’analyser les besoins minimaux de voix et field recordings, puis de préparer les premiers schémas de `material_asset` pour les sources live fixes.
